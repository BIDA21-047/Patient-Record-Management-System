...
def validation():
    ...
    #elif dateofbirth_entry.get().strip() == '':
...
def register_user():
    ...
    cursor.execute("INSERT INTO Doctor (name, surname, email, dateofbirth, gender, contactno, physicaladdress, UserName, Password) VALUES (?, ?, ?, ?, ? , ? , ? , ? , ?)", (name, surname, email, dateofbirth, gender, contactno, physicaladdress, UserName, Password))
...
# Create main window
root = tk.Tk()
root.title("Doctor Registration")
...
# Heading
heading = tk.Label(frame, text="Doctor Registration", font=("Helvetica", 24, "bold"))
heading.pack(padx=5)
...
heading.grid(row=1, column=0, padx=(420, 0), pady=5, sticky="e")
name_label.grid(row=2, column=0, padx=(420, 0), pady=5, sticky="w")
name_entry.grid(row=2, column=0, padx=(620, 0), pady=5, sticky="w")
surname_label.grid(row=3, column=0, padx=(420, 0), pady=5, sticky="w")
surname_entry.grid(row=3, column=0, padx=(620, 0), pady=5, sticky="w")
email_label.grid(row=4, column=0, padx=(420, 0), pady=5, sticky="w")
email_entry.grid(row=4, column=0, padx=(620, 0), pady=5, sticky="w")
dateofbirth_label.grid(row=5, column=0, padx=(420, 0), pady=5, sticky="w")
#dateofbirth_entry.grid(row=5, column=1, padx=10, pady=5, sticky="w")
gender_label.grid(row=6, column=0, padx=(420, 0), pady=5, sticky="w")
contactno_label.grid(row=7, column=0, padx=(420, 0), pady=5, sticky="w")
contactno_entry.grid(row=7, column=0, padx=(620, 0), pady=5, sticky="w")
physicaladdress_label.grid(row=8, column=0, padx=(420, 0), pady=5, sticky="w")
physicaladdress_entry.grid(row=8, column=0, padx=(620, 0), pady=5, sticky="w")
UserName_label.grid(row=9, column=0, padx=(420, 0), pady=5, sticky="w")
UserName_entry.grid(row=9, column=0, padx=(620, 0), pady=5, sticky="w")
Password_label.grid(row=10, column=0, padx=(420, 0), pady=5, sticky="w")
Password_entry.grid(row=10, column=0, padx=(620, 0), pady=5, sticky="w")

#For Gender
#Combobox Selection
gender_combobox = ttk.Combobox(frame, values=["Male", "Female"], state='readonly', width=17)
gender_combobox.grid(row=6, column=0, padx=(620, 0), sticky="w")
